...
?>
        ...
        <section class="mt-4">
            <form class="flex flex-col" method="POST" >
                <div class="mb-4 pt-2 rounded bg-gray-200">
                    ...
                    <input type="text" id="username" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-2">
                </div>
                <div class="mb-4 pt-2 rounded bg-gray-200">
    ...
    <div class="max-w-lg mx-auto text-center mt-4 mb-2">
        <p class="text-white">Already have an account? <a href="index.php" class="font-bold hover:underline">Login</a>.</p>
    </div>
